...
export default function PropertyInner({
  ...
  const updatePhoneFromIti = () => {
    try {
      ...
      const fallback =
        dial && digits ? `${dial}${digits}` : digits ? `+${digits}` : "";
            ...
            .then((data) => {
              const code =
                data && data.country_code
                  ? String(data.country_code).toLowerCase()
                  : "us";
              callback(code);
            })
            .catch(() => callback("us"));
        ...
        <div className="padding-global">
          <div className="container-large">
            <div className="property-widget-sidebar">
              ...
              <div className="space30" />
              {property.units && <Units units={property.units} />}
              <div className="space30" />
              {property.Map_link && (
              ...
              <div className="wrapp-card-details-propertie" id="contact">
                <div className="bg-area">
                  <h3>
                    {t("propertyDetails.send_message-text")} {property.title}
                  </h3>
                    ...
                    <div className="row">
                      ...
                      {submitMessage && (
                        <div className="col-12">
                          <div
                            className={`alert ${submitMessage.includes("Error") ? "alert-danger" : "alert-success"}`}
                          >
                            {submitMessage}
                          </div>
                        </div>
                      ...
                      <div className="col-lg-6">
                        <div className="input-area">
                          <input
                            ...
                            onChange={handleInputChange}
                            placeholder={t(
                              "contact-form.input-preferred_contact_moment",
                            )}
                            required
                          />
                        </div>
                      ...
                      <div className="col-lg-12">
                        ...
                        <div className="d-flex flex-column justify-content-center align-items-center">
                          <p className="text-color-black size-16">
                            {t("contact-form.separator")}
                          </p>
                          <div className="space16" />
                          <button
                            className="vl-btn1"
                            ...
                            onClick={() =>
                              window.open("https://wa.me/34628621130", "_blank")
                            }
                          >
                            <i
