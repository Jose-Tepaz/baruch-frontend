...
export default function Footer1() {
  ...
  useEffect(() => {
    ...
    let link = document.querySelector(
      'link[href*="mailchimp.com/embedcode"]',
    ) as HTMLLinkElement;
    if (!link) {
    ...
    const loadMailchimpScript = () => {
      ...
      const existingScript = document.querySelector(
        'script[src*="mailchimp.com/js/mc-validate"]',
      );
      if (existingScript) {
        return;
      }
  ...
  const handleMailchimpSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    tempForm.action =
      "https://gmail.us20.list-manage.com/subscribe/post?u=801951f17b12d427872e2ac56&id=ce8812881a&f_id=004162eef0";
          ...
          <div className="vl-footer1-section-area">
            <div className="container-fluid">
              <div className="row">
                <div className="col-lg-3 col-md-6">
                  <div className="footer-time-area">
                    ...
                    <ul>
                      ...
                      <li>
                        <Link
                          href="https://www.linkedin.com/company/baruch-real-estate/about"
                          target="_blank"
                        >
                      ...
                      <li>
                        <Link
                          href="https://www.instagram.com/baruchrealestate"
                          target="_blank"
                        >
                ...
                <div className="col-lg col-md-6">
                  ...
                  <div className="footer-widget-area foot-padding1">
                    <p
                      className="text-white text-size-large text-weight-medium"
                      style={{ marginBottom: "16px" }}
                    >
                      {t("footer.head-title-1")}
                    </p>
                  ...
                  <div className="footer-widget-area foot-padding1">
                    ...
                    <ul className="text-white">
                      <li>
                        <Link
                          href={getLocalizedPath(
                            "/services/buying-representation",
                          )}
                          className="text-white"
                        >
                      ...
                      <li>
                        <Link
                          href={getLocalizedPath("/services/sell-your-house")}
                          className="text-white"
                        >
                      ...
                      <li>
                        <Link
                          href={getLocalizedPath("/services/residency-nie")}
                          className="text-white"
                        >
                      ...
                      <li>
                        <Link
                          href={getLocalizedPath("/services/finance")}
                          className="text-white"
                        >
                      ...
                      <li>
                        <Link
                          href={getLocalizedPath("/services/taxes")}
                          className="text-white"
                        >
                      ...
                      <li>
                        <Link
                          href={getLocalizedPath("/services/legal-services")}
                          className="text-white"
                        >
                ...
                <div className="col-lg-3 col-md-4">
                  ...
                  <div className="footer-widget-area foot-padding1">
                    <p
                      ...
                      style={{ marginBottom: "16px" }}
                    >
                      {t("footer.head-title-3")}
                    </p>
                    <ul className="text-white">
                      <li>
                        <Link
                          href={getLocalizedPath(
                            "/properties?location=marbella",
                          )}
                          className="text-white"
                        >
                          {t("footer.title-popular-locations-1")}
                        </Link>
                      </li>
                      <li>
                        <Link
                          href={getLocalizedPath("/properties?location=mijas")}
                          className="text-white"
                        >
                          {t("footer.title-popular-locations-2")}
                        </Link>
                      </li>
                      <li>
                        <Link
                          href={getLocalizedPath(
                            "/properties?location=estepona",
                          )}
                          className="text-white"
                        >
                          {t("footer.title-popular-locations-3")}
                        </Link>
                      </li>
                      <li>
                        <Link
                          href={getLocalizedPath(
                            "/properties?location=sotogrande",
                          )}
                          className="text-white"
                        >
                          {t("footer.title-popular-locations-4")}
                        </Link>
                      </li>
                      <li>
                        <Link
                          href={getLocalizedPath(
                            "/properties?location=the+golden+mile",
                          )}
                          className="text-white"
                        >
                          {t("footer.title-popular-locations-5")}
                        </Link>
                      </li>

                      <li>
                        <Link
                          href={getLocalizedPath("/properties?location=rincon")}
                          className="text-white"
                        >
                          {t("footer.title-popular-locations-7")}
                        </Link>
                      </li>
                      <li>
                        <Link
                          href={getLocalizedPath("/properties?location=torrox")}
                          className="text-white"
                        >
                          {t("footer.title-popular-locations-8")}
                        </Link>
                      </li>
                      <li>
                        <Link
                          href={getLocalizedPath("/properties?location=malaga")}
                          className="text-white"
                        >
                          {t("footer.title-popular-locations-9")}
                        </Link>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="col-lg col-md-4">
                  ...
                  <div className="footer-widget-area foot-padding2">
                    <p
                      ...
                      style={{ marginBottom: "16px" }}
                    >
                      {t("footer.head-title-2")}
                    </p>
                    <ul className="text-white">
                      <li>
                        <Link
                          href={getLocalizedPath("/properties?category=villas")}
                          className="text-white"
                        >
                          {t("footer.category-1")}
                        </Link>
                      ...
                      <li>
                        <Link
                          href={getLocalizedPath(
                            "/properties?property_status=New+Developments",
                          )}
                          className="text-white"
                        >
                          {t("footer.category-3")}
                      ...
                      <li>
                        <Link
                          href={getLocalizedPath(
                            "/properties?category=golf-properties",
                          )}
                          className="text-white"
                        >
                          {t("footer.category-4")}
              ...
              <div>
                ...
                >
                  <p className="text-white">
                    © {new Date().getFullYear()} Baruch Real Estate All Rights
                    Reserved.
                  </p>
                </div>
              </div>
