...
export const metadata: Metadata = {
  ...
  description:
    "Discover our comprehensive real estate services. From buying and selling to property management, we offer everything you need.",
  keywords:
    "real estate services, property services, buying, selling, property management, Baruch",
  openGraph: {
    title: "Our Services - Baruch Real Estate",
    description:
      "Discover our comprehensive real estate services. From buying and selling to property management.",
    type: "website",
    locale: "en_US",
