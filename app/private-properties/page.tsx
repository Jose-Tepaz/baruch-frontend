...
export const metadata: Metadata = {
  ...
  description:
    "Explore our exclusive collection of private properties. Premium real estate listings for discerning clients.",
  keywords:
    "private properties, exclusive listings, premium real estate, luxury properties, Baruch",
  openGraph: {
    title: "Private Properties - Baruch Real Estate",
...
export default async function RootPrivatePropertiesPage({
  searchParams,
}: RootPrivatePropertiesPageProps) {
